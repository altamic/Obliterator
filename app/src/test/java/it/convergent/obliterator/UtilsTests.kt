...
class UtilsTests {
    ...
    fun arrayCarnetToJson() {
        ...
        val carnets = arrayOf(obliteratedFirstTimeCarnet, obliteratedSecondTimeCarnet)
    ...
    fun stringToCarnetArray() {
        ...
        assertEquals(carnets, json.toCarnetArray())

        val empty  = "[]"

        assertEquals(emptySet<Carnet>(), empty.toCarnetArray())
    }
